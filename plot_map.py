...
vals = pd.read_csv('tables/tableForHistograms.csv', encoding='utf-8')
# Presents 1 entry in every 50
latitude_list = vals['coord_lat'].iloc[::10]
longitude_list = vals['coord_lon'].iloc[::10]
